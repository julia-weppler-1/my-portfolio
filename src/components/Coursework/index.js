  ...
  const courses = [
    {
      ...
      description:
        "An advanced exploration of data visualization theory and design, emphasizing interactivity, human-centered design, and storytelling through data. Covered visualization frameworks, cognitive principles, and best practices for communicating complex information effectively.",
    ...
    {
      code: "CS5100",
      title: "Foundations of Artificial Intelligience",
      description:
        "Foundations of Artificial Intelligence is a graduate-level course at Northeastern University covering core AI topics including search algorithms, adversarial agents, Q-learning, policy gradients, Markov models, POMDPs and HMMs, reinforcement learning, Bayesian networks, neural networks, CNNs, and deep learning.",
      work: "Applied genetic algorithms as a search-based optimization technique to the real-world problem of sparse sensor placement for dissolved oxygen monitoring in the Gulf of Mexico.",
    },
    {
      code: "CSCI3390",
      title: "Data Visualization",
      description:
        "This course covered the essential skills needed to understand and communicate data effectively via visuals. I studied the principles from graphic design, perceptual psychology, and cognitive science in order to create effective visualizations. The course emphasized the practical application of these principles through tools like Tableau and web-based frameworks such as D3.js and Vega-Lite.",
    ...
    },
    {
      ...
      description:
        "Studied software development methodologies, program lifecycles, project management, and quality assurance practices. Implemented software engineering principles to develop a software application in a team setting over the course of the semester.",
    ...
    },
    {
      ...
      description:
        "Introduced core concepts in supervised and unsupervised learning, including regression, classification, clustering, and feature selection. Emphasized model evaluation metrics such as accuracy, precision, recall, and F1-score, and explored modern algorithms including neural networks, decision trees, and ensemble methods.",
      ...
      <ul className="course-list">
        {courses.map((course, index) => (
          <li key={index} className="course-item">
            ...
            <p>
              <strong>Work Done:</strong> {course.work}
            </p>
          </li>
        ))}
      </ul>
